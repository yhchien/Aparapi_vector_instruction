...
public class HSAILAssembler{
   ...
   public void addInstructions(ClassModel.ClassModelMethod method){
      ...
      ParseState parseState = ParseState.NONE;
	    ...
	    //Modified @ 2015/05/25
		String teststring = method.getClassName();
	    System.out.print("//Return Value : " );
		System.out.println(teststring.matches("(.*)Vector(.*)"));
		boolean checkVector = teststring.matches("(.*)Vector(.*)");
		System.out.println("result is"+checkVector);
		//
