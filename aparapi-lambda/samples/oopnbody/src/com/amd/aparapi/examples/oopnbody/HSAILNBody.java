...
public class HSAILNBody{
   ...
   /*20140916 modify this*/
   public static void main(String[] _args){
      (new HSAILNBody()).go(Device.getByName(/*System.getProperty("mode", "hsa"))*/"hsa"), Integer.getInteger("bodies", 256));
   }

   void go(Device device, int bodyCount){

      PixelRenderer pr = new PixelRenderer(Integer.getInteger("width", 512), Integer.getInteger("height", 512));
