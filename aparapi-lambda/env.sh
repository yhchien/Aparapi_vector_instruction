#export TOP=/home/${LOGNAME}(modified)
export TOP=/home/hsaserver
...
#export JAVA_HOME=${TOP}/jdk1.8.0(modified)
export JAVA_HOME=${TOP}/jdk1.8.0_20
...
#export OCL_HOME=${TOP}/ocl(modified)
...
#export OKRA_HOME=${TOP}/okra(modified)
